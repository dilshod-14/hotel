...
@UseGuards(AuthGuard)
@Mutation(() => Property)
public async rateProperty(
  @Args('input') input: RatePropertyInput,
  @AuthMember('_id') memberId: ObjectId,
): Promise<Property> {
  console.log('Mutation: rateProperty');
  return await this.propertyService.rateProperty(memberId, input);
}
